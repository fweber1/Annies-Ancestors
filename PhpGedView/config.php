 ...
 * @subpackage Admin
 * @see install.php
 * @version $Id: config.dist 6692 2010-01-07 23:26:51Z fisharebest $
 */
...
$DBPASS='mcwskw1'; //-- MySQL database User Password
$DBNAME='db1098262_ancestors'; //-- The MySQL database name where you want PHPGedView to build its tables
$DB_UTF8_COLLATION=false; //-- Use the database to sort/collation UTF8 text
$TBLPREFIX=''; //-- prefix to include on table names
...
$PGV_MEMORY_LIMIT = "128M";						//-- the maximum amount of memory that PGV should be allowed to consume
