/*******************************************************
 ...
 ToDo: add others to family DB
 ToDo: add others to getFamily.php
...
(function () {
    ...
    function EditFamilyController($scope, $state, $mdDialog, EditService, UtilityFactory, Gparams) {
        ...
        vm.doChange6 = doChange6;				//prototype function declaration so can be called before defined
...
// ToDo: make it real for production
        ...
        $scope.showConfirm = function () {
            var confirm = $mdDialog.confirm()
                ...
                .textContent('The person will be permanently removed from the family and this can not be undone.')
