/* ******************************************************
 ...
 Attribute Controller
  ...
  ToDo: prevent duplicate attributes where they don't make sense
  ToDo: hide/show areas for appropriate attributes
  ToDo: disable clear button after form submisstion since form is empty at that point
...
(function () {    'use strict';
    ...
    EditAttributeController.$inject = [ '$scope', '$filter', '$state', '$mdDialog', 'UtilityFactory', 'EditService', 'KindiAttrStruct','KdateModifiers', 'Gparams'];
		function EditAttributeController($scope,   $filter,   $state,   $mdDialog,   UtilityFactory,   EditService,   KindiAttrStruct,  KdateModifiers,   Gparams) {
 			var vm = this;
